...
def analyze_and_save(args, eval_args, device, generative_model,
    ...
    for i in range(int(n_samples/batch_size)):
        print('Nodes distribution', nodes_dist)
        nodesxsample = nodes_dist.sample(batch_size)
        print('Nodes per sample', nodesxsample)
...
def main():
    ...
    print('Nodes distribution', nodes_dist)
    print('Number of nodes in nodes distribution', nodes_dist.n_nodes)
    print('Nodes dist probs:', nodes_dist.prob)
