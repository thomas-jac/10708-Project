...
# job name
#SBATCH --job-name=eval_sample_voxmol
...
#SBATCH --error=eval_sample_voxmol.err
#SBATCH --output=eval_sample_voxmol.out
...
python /net/dali/home/uttam/thj19/10708-Project/GeoLDM-exp/eval_sample_voxmol.py --model_path /net/dali/home/uttam/thj19/10708-Project/GeoLDM-exp/shell_scripts/outputs/geoldm_qm9_2 --n_samples 25