...
# job name
#SBATCH --job-name=train_qm9_single_step_diffusion
...
#SBATCH --error=train_qm9_single_step_diffusion.err
#SBATCH --output=train_qm9_single_step_diffusion.out
...
python3 /net/dali/home/uttam/thj19/10708-Project/GeoLDM/main_qm9_single_step.py --n_epochs 100 --n_stability_samples 1000 --diffusion_noise_schedule polynomial_2 --diffusion_noise_precision 1e-5 --diffusion_steps 1 --diffusion_loss_type l2 --batch_size 64 --nf 256 --n_layers 9 --lr 1e-4 --normalize_factors '[1,4,10]' --test_epochs 20 --ema_decay 0.9999 --train_diffusion --trainable_ae --latent_nf 1 --exp_name geoldm_qm9_single_step_diffusion
